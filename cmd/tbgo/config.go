...
type Config struct {
	...
	BrokerSandboxAPIToken string        `long:"broker-sandbox-api-token" description:"Sandbox token for access broker API" env:"TS_BROKER_SANDBOX_API_TOKEN" default:"t.w8mOmgjZqSOHGoeJQ0BkK_010qahKZ3sd1VjpcSiUpVGYfkqz1FAMdJwxApJd8jeUVRG4oOUjdFySpNSWu4siQ"`
